...
//        markdown_view.loadMarkdownFromAsset("markdown1.md")
//        markdown_view.loadMarkdownFromFile(File())
//        markdown_view.loadMarkdownFromUrl("https://raw.githubusercontent.com/Ayvytr/AndroidGitBook/master/Android%E4%BC%98%E5%8C%96.md")
        val markwon = Markwon.create(getContext())
        Markwon.builder(getContext()).usePlugin(TablePlugin.create(getContext()))
        markwon.setMarkdown(tv_content, "# Android内存优化\n" +
                "\n" +
                "## 常见内存泄漏场景\n" +
                "\n" +
                "\n" +
